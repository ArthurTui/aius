...
# Load resources
#var play = preload("res://menus/main menu/buttons/play.png")
#var settings = preload("res://menus/main menu/buttons/settings.png")
#var credits = preload("res://menus/main menu/buttons/credits.png")
#var quit = preload("res://menus/main menu/buttons/quit.png")
#
#var play_glow = preload("res://menus/main menu/buttons/play_glow.png")
#var settings_glow = preload("res://menus/main menu/buttons/settings_glow.png")
#var credits_glow = preload("res://menus/main menu/buttons/credits_glow.png")
#var quit_glow = preload("res://menus/main menu/buttons/quit_glow.png")
#
